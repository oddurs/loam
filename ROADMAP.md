...
- [ ] `0051` The manifest is a documented, versioned output <sup>spec · p0 · s</sup>
- [ ] `0052` index --json: the whole docs tree as one document <sup>feature · p0 · m</sup>
- [ ] `0053` Backlinks <sup>feature · p1 · s</sup>
